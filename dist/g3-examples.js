        ...
        function ticks(sel, g) {
            ...
            switch(shape) {
                ...
                case 'rect':
                    ...
                    break;
                default:
                    _.append('path').attr('d', line$1()([[0, 0], [0, size]]));
            }
        }
...
`)
    ...
    let deviationScale = linear().domain([-10,10]).range([-50,50]);
    ...
    */
    ...
    panel('DHC2FlightPanel').width(320*4).height(320*2).append(
        ...
        ].map((k, i) => put().x(320*(i%4)+160).y(320*Math.floor(i/4)+160).scale(1.28).append(gauge(k)))
    );

    panel('DHC2EnginePanel').width(320*2).height(320*4).append(
        put().x(160).y(160).scale(1.28).append(gauge('manifoldPressureDHC2')),
        put().x(480).y(160).scale(1.28).append(gauge('engineTachometerDHC2')),
        put().x(120).y(420).scale(0.8).append(gauge('suctionPressureDHC2')),
        put().x(320).y(420).scale(0.8).append(gauge('fuelDHC2')),
        put().x(520).y(420).scale(0.8).append(gauge('oilFuelDHC2')),
        put().x(160).y(680).scale(1.28).append(gauge('carbMixtureTempDHC2')),
        put().x(480).y(680).scale(1.28).append(gauge('cylinderHeadTempDHC2')),
        put().x(160).y(1000).scale(1.28).append(gauge('voltmeterDHC2')),
