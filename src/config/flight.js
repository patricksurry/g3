...
g3.gauge('altitudeDHC2')
    ...
    .defs(
        ...
        }).append(g3.element('rect', {width: 10, height: 5}).class('sector-light')),
    )
    .append(
    ...
    .append(
        ...
        g3.gauge('rollDHC2')
            ...
            .append(
                    ...
                    g3.gauge('pitchDHC2')
                        ...
                        .append(
                            g3.element('rect', {height: 200, width: 150, y: -100}) // sky
                                .class('sector-blue').class('gauge-axis'),
                            g3.element('rect', {height: 200, width: 150, x: -150, y: -100}) // ground
                                .style('fill: #6B5634').class('gauge-axis'),
                ...
                g3.axisSector([-90,90]).size(20).class('sector-blue').class('gauge-axis'),
                g3.axisSector([90,270]).size(20).style('fill: #6B5634').class('gauge-axis'),
        ...
        g3.element('circle', {r: 100}).class('gauge-axis'),
        // top pointer
        ...
        g3.element('path', {d: 'M -15,0 a 15,10 0 0 0 30,0 M 0,10 l 0,35'})
            .class('stroke-dark').style('stroke-width: 3; filter: url(#dropShadow1)'),
        g3.element('path', {d: 'M 0,40 l 15,38 a 100,100 0 0 1 -30,0 z'})
            .class('gauge-face').style('filter: url(#dropShadow1)'),
...
g3.gauge('VORDHC2')
    ...
    .append(
        ...
        g3.element('circle', {r: deviationScale(2)}).class('gauge-axis-ticks').style('stroke-width: 2; fill: none'),
        ...
        g3.element('path', {d: 'M 35,25 l 8,-14 l -16,0 z', fill: 'orange'}),
        g3.element('path', {d: 'M 35,-25 l 8,14 l -16,0 z'}).class('gauge-face'),
        ...
        g3.indicatePointer().append(
            g3.element('path', {d: 'M 0,-100 L 0,100'}).class('gauge-axis').style('stroke-width: 4')
        ),
...
g3.gauge('ADFDHC2')
    ...
    .append(
        ...
        g3.indicatePointer().append(
            g3.element('path', {d: 'M 0,-65 L 0,60'}).class('gauge-axis').style('stroke-width: 4'),
            g3.element('path', {d: 'M 0,65 l 5,-15 l -10,0 z'}).class('sector-light'),
        ),
        // heading marks
...
g3.gauge('vsiDHC2')
    ...
    .append(
        ...
        g3.axisSector([100,400]).size(0).inset(25).class('gauge-axis').style('stroke-width: 2'),
        g3.axisSector([-100,-400]).size(0).inset(25).class('gauge-axis').style('stroke-width: 2'),
...
g3.gauge('turnCoordinatorDHC2')
    ...
    .append(
                ...
                g3.put().y(-255).append(
                    ...
                    g3.indicatePointer().append(
                        g3.put().scale(0.8,1).y(-300).rotate(-180).append(
                            ...
                            g3.element('circle', {r: 8}).style('fill: url(#highlightGradient); fill-opacity: 0.5'),
                        )
                    ),
        ...
        g3.axisSector([0,360]).size(24).class('gauge-face').style('filter: url(#dropShadow2)'),
